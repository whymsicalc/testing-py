...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Judith Bulter', 'mel@ubermelon.com')
    True
    >>> is_mel('mel m', 'mel@ubermelon.com')
    True
    >>> is_mel('mel', 'mel@ubermelon.COM')
    True
    """

    return (name.lower() in "mel melitpolski") or email.lower() == "mel@ubermelon.com"
...
def most_and_least_common_type(treats):
    ...
    ('dessert', 'drink')
    >>> most_and_least_common_type([{'type': 'drink'}, {'type': 'drink'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}, {'type': 'drink'}])
    ('drink', 'dessert')
    >>> most_and_least_common_type([{'type': 'drink'}, {'type': 'drink'}, {'type': 'appetizer'}, {'type': 'appetizer'}])
    ('drink', 'drink')
